...
# def plot_data_and_model_fit(time, concentrations_species, species_colors, drug_application_time=None, ylim_val=False, save_figure=True, plot_name='model_fit.jpg', time_points=None, observations_data_mean=None, observations_data_sem=None, folder_outputs=None):
#     """
#     Plot data with error bars and model fits in a single figure.

#     Parameters:
#     - time: array-like, time points of the simulation/model fit.
#     - concentrations_species: dict, model fit data, keys are species names.
#     - species_colors: dict, keys are species names, values are color codes.
#     - drug_application_time: float, time at which drug is applied.
#     - ylim_val: float or False, y-axis limit.
...
#     - time_points: array-like, time points of the observations.
#     - observations_data_mean: list of arrays, mean observations for each species.
#     - observations_data_sem: list of arrays, standard deviation of observations for each species.
#     - folder_outputs: pathlib.Path or str, directory to save the figure.
#     """
...
#     plt.errorbar(
#         time_points, observations_data_mean[0], yerr=observations_data_sem[0], fmt='o',
#         color=species_colors['P'], label='Spatial Model ' + f"${'(P)'}$", markersize=10, lw=1
#     )
#     plt.errorbar(
#         time_points, observations_data_mean[1], yerr=observations_data_sem[1], fmt='o',
#         color=species_colors['R_n'], label='Spatial Model ' + f"${'(R_n)'}$", markersize=10, lw=1
#     )
#     plt.errorbar(
#         time_points, observations_data_mean[2], yerr=observations_data_sem[2], fmt='o',
#         color=species_colors['R_c'], label='Spatial Model ' + f"${'(R_c)'}$", markersize=10, lw=1
#     )

#     # Plot model fits
#     plt.plot(
#         time, concentrations_species['P'], color=species_colors['P'],
#         label='Model Fit ' + f"${'(P)'}$", lw=2, linestyle='--'
#     )
#     plt.plot(
#         time, concentrations_species['R_n'], color=species_colors['R_n'],
#         label='Model Fit ' + f"${'(R_n)'}$", lw=2, linestyle='--'
#     )
#     plt.plot(
#         time, concentrations_species['R_c'], color=species_colors['R_c'],
#         label='Model Fit ' + f"${'(R_c)'}$", lw=2, linestyle='--'
#     )

#     # Plot drug application time
#     if drug_application_time is not None and drug_application_time > 0:
#         plt.axvline(
#             x=drug_application_time, color='k', linestyle='--',
#             label='Drug Application', lw=2
#         )
...
#         if folder_outputs is not None:
#             plt.savefig(
#                 folder_outputs.joinpath(plot_name), dpi=300, bbox_inches='tight',
